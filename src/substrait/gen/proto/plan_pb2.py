...
PlanRel = _reflection.GeneratedProtocolMessageType('PlanRel', (_message.Message,), {'DESCRIPTOR': _PLANREL, '__module__': 'proto.plan_pb2'})
_sym_db.RegisterMessage(PlanRel)
Plan = _reflection.GeneratedProtocolMessageType('Plan', (_message.Message,), {'DESCRIPTOR': _PLAN, '__module__': 'proto.plan_pb2'})
_sym_db.RegisterMessage(Plan)
PlanVersion = _reflection.GeneratedProtocolMessageType('PlanVersion', (_message.Message,), {'DESCRIPTOR': _PLANVERSION, '__module__': 'proto.plan_pb2'})
_sym_db.RegisterMessage(PlanVersion)
Version = _reflection.GeneratedProtocolMessageType('Version', (_message.Message,), {'DESCRIPTOR': _VERSION, '__module__': 'proto.plan_pb2'})
