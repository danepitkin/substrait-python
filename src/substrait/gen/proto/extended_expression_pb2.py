...
ExpressionReference = _reflection.GeneratedProtocolMessageType('ExpressionReference', (_message.Message,), {'DESCRIPTOR': _EXPRESSIONREFERENCE, '__module__': 'proto.extended_expression_pb2'})
_sym_db.RegisterMessage(ExpressionReference)
ExtendedExpression = _reflection.GeneratedProtocolMessageType('ExtendedExpression', (_message.Message,), {'DESCRIPTOR': _EXTENDEDEXPRESSION, '__module__': 'proto.extended_expression_pb2'})
