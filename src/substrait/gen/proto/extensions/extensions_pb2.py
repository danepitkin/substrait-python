...
AdvancedExtension = _reflection.GeneratedProtocolMessageType('AdvancedExtension', (_message.Message,), {'DESCRIPTOR': _ADVANCEDEXTENSION, '__module__': 'proto.extensions.extensions_pb2'})
