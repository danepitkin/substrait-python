...
Capabilities = _reflection.GeneratedProtocolMessageType('Capabilities', (_message.Message,), {'SimpleExtension': _reflection.GeneratedProtocolMessageType('SimpleExtension', (_message.Message,), {'DESCRIPTOR': _CAPABILITIES_SIMPLEEXTENSION, '__module__': 'proto.capabilities_pb2'}), 'DESCRIPTOR': _CAPABILITIES, '__module__': 'proto.capabilities_pb2'})
